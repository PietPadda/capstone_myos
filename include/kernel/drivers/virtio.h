...
#define VIRTIO_SND_PCM_FMT_U8           4 // Unsigned 8-bit PCM
#define VIRTIO_SND_PCM_FMT_S16_LE       5 // Signed 16-bit Little Endian PCM
#define VIRTIO_SND_PCM_RATE_44100       6 // 44100 Hz
